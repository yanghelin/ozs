...
<table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td align="center" class="pn-sp">
	...
	每页<input type="text" value="${value.pageSize}" style="width:30px" onfocus="this.select();" onblur="refresh(this.value)" onkeypress="if(event.keyCode==13){$(this).blur();return false;}"/>条&nbsp;
