...
public class RegisterAct {
	...
	@RequestMapping(value = "/zh/register.jspx", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/zh/register.jspx", method = RequestMethod.POST)
	public String registerSubmit(String username, String email, String password,
			CmsUserExt userExt, String captcha, String nextUrl,
			HttpServletRequest request, HttpServletResponse response,
			ModelMap model) throws IOException {
		CmsSite site = CmsUtils.getSite(request);
