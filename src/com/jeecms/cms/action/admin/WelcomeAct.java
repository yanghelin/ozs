...
public class WelcomeAct {
	...
	@RequiresPermissions("top")
	@RequestMapping("/ememberTop.do")
	public String ememberTop(HttpServletRequest request, ModelMap model) {
	...
	@RequiresPermissions("main")
	@RequestMapping("/ememberMain.do")
	public String ememberMain() {
		return "ememberMain";
	...
	@RequestMapping("/memberLeft.do")
	public String memberLeft(HttpServletRequest request, ModelMap model) {
		/*CmsUser user = CmsUtils.getUser(request);
		List<CmsUserMenu>menus=userMenuMng.getList(user.getId(),10);
		model.addAttribute("menus", menus);*/
		return "memberLeft";
	...
	@RequestMapping("/memRight.do")
	public String memRight(HttpServletRequest request, ModelMap model) {
		/*CmsUser user = CmsUtils.getUser(request);
		List<CmsUserMenu>menus=userMenuMng.getList(user.getId(),10);
		model.addAttribute("menus", menus);*/
		return "memRight";
